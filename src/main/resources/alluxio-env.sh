...
ALLUXIO_MASTER_HOSTNAME=${ALLUXIO_MASTER_HOSTNAME:-"10.85.126.106"}
...
ALLUXIO_RAM_FOLDER=/data0/workspace/alluxio
...
ALLUXIO_WORKER_MEMORY_SIZE=${ALLUXIO_WORKER_MEMORY_SIZE:-"15GB"}
